...
class thesises extends Controller
{
    ...
    function view_upload()
    {
        ...
        if ($uploadOk == 0) {
            ...
            $query = "INSERT INTO thesis_files (thesis_file_name, thesis_id, thesis_file_size, thesis_file_type, thesis_file_content ) " .
    ...
    function file()
    {
        ...
        $file = get_first("SELECT * FROM thesis_files WHERE thesis_file_id = '$thesis_file_id' ");
    ...
    function edit_ajax()
    {
        $thesis = $_POST['thesises'];
        $this->thesis_id = $this->params[0];

        // Update thesis properties
        update('thesises', $thesis, "thesis_id = '{$this->thesis_id}'");
    ...
    {
        $thesis_id = $this->params[0];
        update('thesises', array('thesis_deleted' => 1), "thesis_id = '{$thesis_id}'");
    ...
    function confirmation_request()
    {
        ...
        q("BEGIN");
        update('thesises', array('instructor_id' => $instructor_id, 'thesis_idea' => NULL), "thesis_id = '{$thesis_id}'");
    ...
    {
        $thesis_id = $this->params[0];
        update('thesises', array('thesis_title_confirmed_at' => date('Y-m-d')), "thesis_id = '{$thesis_id}'");
        header('Location: ' . BASE_URL . "thesises/view/$thesis_id");
    ...
    {
        $thesis_id = $this->params[0];
        update('thesises', array('thesis_defended_at' => date('Y-m-d')), "thesis_id = '{$thesis_id}'");
        header('Location: ' . BASE_URL . "thesises/view/$thesis_id");
    ...
    {
        $thesis_id = $this->params[0];
        update('thesises', array('thesis_defended_at' => NULL), "thesis_id = '{$thesis_id}';");
        header('Location: ' . BASE_URL . "thesises/view/$thesis_id");
    ...
    function add_post()
    {
        $data1 = $_POST['thesises'];
        $data1['instructor_id'] = $_POST['instructor_select'];
        $person_id = $this->auth->person_id;
        q("BEGIN");
        $thesis_id = insert('thesises', $data1);
    ...
    function suggested_thesis()
    {
        ...
        $data['thesis_idea'] = "1";
        $thesis_id = insert('thesises', $data);
        header('Location: ' . BASE_URL . 'thesises/' . $thesis_id);
    }
